...
<html lang="en">
  ...
  <body class="sbgcolor">
<?php require "admin_partials/admin_nav.php" ?>
        <?php
    if($showAlert){
...
<div class="container">
    ...
    <div id="name" class=" mb-3 col-md-6 ">
        ...
        <input type="text" class="form-control" id="fname"  name="aname"  placeholder="Enter Your Name" aria-describedby="emailHelp" autocomplete="off" >
    </div>


    <div id="lname" class=" mb-3 col-md-6 ">
        <label for="username" class="form-label" >Number</label>
        <input type="text" class="form-control"  name="lname" id="amobileno" placeholder="Enter Your Mobile Number" aria-describedby="emailHelp" autocomplete="off">
    </div>


    <div id="email" class=" mb-3 col-md-6">
        <label for="username" class="form-label" >Email </label>
        <input type="text" class="form-control" name="email" id="aemail" placeholder="Enter Your Email" aria-describedby="emailHelp" autocomplete="off" >
    </div>
