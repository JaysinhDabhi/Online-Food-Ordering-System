...
?>
<div class="container">
    <h1 class="text-center m-3"> Add Restaurant </h1>
    ...
    <div id="name" class=" mb-3 col-md-6 ">
        ...
        <input type="text" class="form-control" id="fname"  name="fname"  placeholder="Enter Your Name" aria-describedby="emailHelp" autocomplete="off" >
    </div>


    <div id="lname" class=" mb-3 col-md-6 ">
        <label for="username" class="form-label" >Number</label>
        <input type="text" class="form-control"  name="lname" id="lname" placeholder="Enter Your Number" aria-describedby="emailHelp" autocomplete="off">
    </div>


    <div id="email" class=" mb-3 col-md-6">
        <label for="username" class="form-label" >Email </label>
        <input type="text" class="form-control" name="email" id="email" placeholder="Enter Your Email Id" aria-describedby="emailHelp" autocomplete="off" >
    </div>

    <div id="email" class=" mb-3 col-md-6">
        <label for="username" class="form-label" >City </label>
        <input type="text" class="form-control" name="email" id="email" placeholder="Enter Your City" aria-describedby="emailHelp" autocomplete="off" >
    </div>

    <div id="email" class=" mb-3 col-md-6">
        <label for="username" class="form-label" >State </label>
        <input type="text" class="form-control" name="email" id="email" placeholder="Enter Your State" aria-describedby="emailHelp" autocomplete="off" >
    </div>

    <div id="email" class=" mb-3 col-md-6">
        <label for="username" class="form-label" >Pincode </label>
        <input type="text" class="form-control" name="email" id="email" placeholder="Enter Your Pincode" aria-describedby="emailHelp" autocomplete="off" >
    </div>

    <div id="email" class=" mb-3 col-md-6">
        <label for="username" class="form-label" >Upload Image </label>
        <input type="File" class="form-control" name="email" id="email" placeholder="Enter Your Pincode" aria-describedby="emailHelp" autocomplete="off" >
    </div>
